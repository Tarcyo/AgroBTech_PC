...
import 'package:midas/pages/createFileScreen/laudoMicrobiológico/tableOfResults.dart';
                    ...
                    child: pw.Column(
                      children: [
                        pw.Container(
                            ...
                            child: pw.Center(
                                child: pw.Text("INTERPRETAÇÃO DOS RESULTADOS",
                                    style: pw.TextStyle(
                                        fontWeight: pw.FontWeight.bold,
                                        fontSize: 14,
                                        color: PdfColors.white)))),
                            ...
                            children: [
                              ...
                              pw.Expanded(
                                child: pw.Container(
                                  child: pw.Center(
                                    child: pw.Text(
                                      criteriaByFactorControllers[0].text,
                              ...
                              pw.Expanded(
                                child: pw.Container(
                                  child: pw.Center(
                                    child: pw.Text(
                                      criteriaByMacrophominaControllers[0].text,
                                      style: pw.TextStyle(fontSize: 7),
                                    ),
                                  ),
                                ),
                            ...
                            children: [
                              ...
                              pw.Expanded(
                                child: pw.Container(
                                  child: pw.Center(
                                    child: pw.Text(
                                      criteriaByFactorControllers[1].text,
                                      style: pw.TextStyle(fontSize: 7),
                                    ),
                                  ),
                                ),
                              ...
                              pw.Expanded(
                                child: pw.Container(
                                  child: pw.Center(
                                    child: pw.Text(
                                      criteriaByMacrophominaControllers[1].text,
                                      style: pw.TextStyle(fontSize: 7),
                                    ),
                                  ),
                                ),
                            ...
                            children: [
                              ...
                              pw.Expanded(
                                child: pw.Container(
                                  child: pw.Center(
                                    child: pw.Text(
                                      criteriaByFactorControllers[2].text,
                                      style: pw.TextStyle(fontSize: 7),
                                    ),
                                  ),
                                ),
                              ...
                              pw.Expanded(
                                child: pw.Container(
                                  child: pw.Center(
                                    child: pw.Text(
                                      criteriaByMacrophominaControllers[2].text,
                                      style: pw.TextStyle(fontSize: 7),
                                    ),
                                  ),
                                ),
                            ...
                            children: [
                              ...
                              pw.Expanded(
                                child: pw.Container(
                                  child: pw.Center(
                                    child: pw.Text(
                                      criteriaByFactorControllers[3].text,
                                      style: pw.TextStyle(fontSize: 7),
                                    ),
                                  ),
                                ),
                              ...
                              pw.Expanded(
                                child: pw.Container(
                                  child: pw.Center(
                                    child: pw.Text(
                                      criteriaByMacrophominaControllers[3].text,
                                      style: pw.TextStyle(fontSize: 7),
                                    ),
                                  ),
                                ),
                        ...
                        pw.Row(
                            ...
                            children: [
                              pw.Column(
                                  ...
                                  children: [
                                    pw.Text("Base de dados: Geraldine (2021)",
                                        style: pw.TextStyle(
                                            fontWeight: pw.FontWeight.bold,
                                            color: PdfColors.grey,
                                            fontSize: 8)),
