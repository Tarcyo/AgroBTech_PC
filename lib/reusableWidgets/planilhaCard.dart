...
class PlanilhaCard extends StatelessWidget {
  final String _nomeDoArquivo;
  final String _tipoArquivo;

  PlanilhaCard(this._nomeDoArquivo, this._tipoArquivo);
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (_tipoArquivo ==
                                          ...
                                          Provider.of<FileNameProvider>(
                                              ...
                                              .removeControleDeQualidadePlanilha(
                                                  _nomeDoArquivo);
                                        }
                                        if (_tipoArquivo ==
                                        ...
                                        if (_tipoArquivo ==
                                          ...
                                          Provider.of<FileNameProvider>(
                                                  listen: false, context)
                                              .removeMicrobiologicoPlanilha(
                                                  _nomeDoArquivo);
                                        }
                                        if (_tipoArquivo == "Laudo Diagnose") {
                                          Provider.of<FileNameProvider>(
                                                  listen: false, context)
                                              .removeDiagnosePlanilha(
                                                  _nomeDoArquivo);
                                        }
                                        if (_tipoArquivo ==
                                            "Raça de Nematóides") {
                                          Provider.of<FileNameProvider>(
                                                  listen: false, context)
                                              .removeDiferenciacaoDeRacaPlanilha(
                                                  _nomeDoArquivo);
                                        }
    ...
    try {
      ...
      if (await Directory(rascunhosPath).exists()) {
        ...
        if (await File(filePath).exists()) {
          ...
          print('O arquivo "$fileName" não existe na pasta "meu planilhas".');
          return "";
        }
      } else {
